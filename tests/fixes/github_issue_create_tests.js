...
function mockStandardGithubApiCalls(repoIssues, githubIssueTemplate) {
  nock('https://api.github.com')
    .get(
      `/repos/test/tester-repo/issues?labels=repolinter%2Cautomated&state=all&sort=created&direction=desc`
    )
    .reply(200, repoIssues)

  nock('https://api.github.com')
    .get(`/repos/test/tester-repo/labels/repolinter`)
    .reply(200)
  nock('https://api.github.com')
...
describe('fixes', () => {
  describe('github-issue-create', () => {
    ...
    const validOptions = {
      issueCreator: 'Repolinter',
      issueLabels: ['repolinter', 'automated'],
      bypassLabel: 'CC: Bypass',
      issueTitle: 'Repolinter - Valid test 👍',
      issueBody:
        'Hi there 👋, \n' +
        ' Repolinter tries to make sure that repositories in this organization follow a certain standardization. While reviewing your repository, we could not stop ourselves to further improve this repository! \n' +
        ' We are happy to help you set up a nice Read me, please head over to Slack and we will get you set up. \n' +
        ' Auto-generated issue by Repolinter',
      commentBody:
        ...
        ' Thanks!',
      uniqueRuleId: '66b2a899-0fab-423c-99b9-ed88d958f19d'
    }

    const githubIssue = {
      url: 'https://api.github.com/repos/Repo-User/octokit-test-repo/issues/17',
      repository_url:
        'https://api.github.com/repos/Repo-User/octokit-test-repo',
      labels_url:
        'https://api.github.com/repos/Repo-User/octokit-test-repo/issues/17/labels{/name}',
      comments_url:
        'https://api.github.com/repos/Repo-User/octokit-test-repo/issues/17/comments',
      events_url:
        'https://api.github.com/repos/Repo-User/octokit-test-repo/issues/17/events',
      html_url: 'https://github.com/Repo-User/octokit-test-repo/issues/17',
      id: 925545239,
      node_id: 'MDU6SXNzdWU5MjU1NDUyMzk=',
      number: 17,
      title: 'Repolinter - Valid test 👍',
      user: {
        login: 'Repo-User',
        id: 15904543,
        ...
        gravatar_id: '',
        url: 'https://api.github.com/users/Repo-User',
        html_url: 'https://github.com/Repo-User',
        followers_url: 'https://api.github.com/users/Repo-User/followers',
        following_url:
          'https://api.github.com/users/Repo-User/following{/other_user}',
        gists_url: 'https://api.github.com/users/Repo-User/gists{/gist_id}',
        starred_url:
          'https://api.github.com/users/Repo-User/starred{/owner}{/repo}',
        subscriptions_url:
          'https://api.github.com/users/Repo-User/subscriptions',
        organizations_url: 'https://api.github.com/users/Repo-User/orgs',
        repos_url: 'https://api.github.com/users/Repo-User/repos',
        events_url: 'https://api.github.com/users/Repo-User/events{/privacy}',
        received_events_url:
          'https://api.github.com/users/Repo-User/received_events',
        type: 'User',
        site_admin: false
      },
      labels: [
        {
          ...
          url:
            'https://api.github.com/repos/Repo-User/octokit-test-repo/labels/CC:%20Bypass',
          name: 'CC: Bypass',
          color: 'ededed',
          default: false,
          description: null
        },
        {
          ...
          url:
            'https://api.github.com/repos/Repo-User/octokit-test-repo/labels/automated',
          name: 'automated',
          color: 'ededed',
          default: false,
          description: null
        },
        {
          ...
          url:
            'https://api.github.com/repos/Repo-User/octokit-test-repo/labels/repolinter',
          name: 'repolinter',
          color: '99adc1',
          default: false,
          description: null
      ...
      body:
        ...
        ' We are happy to help you set up a nice Read me, please head over to Slack and we will get you set up. \n' +
        ' Auto-generated issue by Repolinter\n' +
        ' Unique rule set ID: 66b2a899-0fab-423c-99b9-ed88d958f19d',
          ...
          describe('with unique rule identifier in body', () => {
            it('it should return the proper unique identifier of the issue', async () => {
              ...
              expect(uniqueIdentifier).to.be.equal(
                '66b2a899-0fab-423c-99b9-ed88d958f19d'
              )
            })
          })
        })
